...
const commandData = new SlashCommandBuilder()
  ...
  .addRoleOption((option) =>
    option
      .setName("role")
      .setDescription(
        "The bot assigns a role to verified users. To remove it, select the assigned role.",
      )
      .setRequired(true),
  );
    ...
    return await interaction.reply({
      embeds: [
        new EmbedBuilder()
          ...
          .setDescription(
            `"${role?.name}" is now the role that will be given to users who verify!`,
          )
          .setColor("Green"),
      ],
    });
    ...
    return await interaction.reply({
      embeds: [
        new EmbedBuilder()
          ...
          .setDescription(
            "The role given to verified users has now been removed.",
          )
          .setColor("Green"),
      ],
    });
